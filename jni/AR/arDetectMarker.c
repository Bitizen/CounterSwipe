...
*/
           ...
           __android_log_print(ANDROID_LOG_INFO,"POSITION","wmarker_info[%d].POSITION: Y = %f; X = %f",i,wmarker_info[i].pos[0], wmarker_info[i].pos[1]); 						// EDITED
           __android_log_print(ANDROID_LOG_INFO,"POSITION","wmarker_info[%d].RELATIVE_POSITION: Y = %f; X = %f",i,wmarker_info[i].pos[0]/480.0, wmarker_info[i].pos[1]/320.0); 	// EDITED
#endif
